...
<div class="container">
    ...
    <div class="row">
        <c:forEach items='${requestScope["searchList"]}' var="cake" varStatus="loop">
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <button class="btn btn-success btn-md" data-toggle="modal" data-target="#buyModal">Buy
                            </button>
                        </div>
                        ...
                        <div class="modal fade" id="buyModal" tabindex="-1" aria-labelledby="buyModalLabel"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="buyModalLabel">Enter Your Information</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
